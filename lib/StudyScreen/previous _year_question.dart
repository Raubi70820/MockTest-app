...
class PreviousYearQuestion extends StatefulWidget {
  const PreviousYearQuestion({super.key});

  @override
  State<PreviousYearQuestion> createState() => _PreviousYearQuestionState();
}

class _PreviousYearQuestionState extends State<PreviousYearQuestion> {
  @override
